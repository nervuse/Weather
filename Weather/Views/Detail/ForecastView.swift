...
struct ForecastView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 0) {
                // MARK: Segmented Control - сегментированный контроль
                SegmentedControl(selection: $selection)
                
                // MARK: Forecast Cards - карты прогноза
                ...
                // MARK: Forecast Widgets - виджеты прогноза
        ...
        .overlay {
            // MARK: Bottom Sheet Separator - разделитель нижнего листа
            Divider()
                .blendMode(.overlay)
        ...
        .overlay {
            // MARK: Drag Indicator - индикатор перетаскивания
