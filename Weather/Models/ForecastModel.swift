...
extension Forecast {
    ...
    static let hourly: [Forecast] = [
        ...
        Forecast(date: .init(timeIntervalSinceNow: hour * 2), weather: .rainy, probability: 0, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
    ...
    static let daily: [Forecast] = [
        ...
        Forecast(date: .init(timeIntervalSinceNow: hour * 5), weather: .rainy, probability: 0, temperature: 19, high: 24, low: 18, location: "Montreal, Canada")
    ]
